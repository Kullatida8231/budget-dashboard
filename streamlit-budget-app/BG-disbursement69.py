...
@st.cache_data
def load_data():
    file_path = "q3-69 June.xlsx"                                        # 📑📑📑 เปลี่ยนชื่อไฟล์
...
# ══════════════════════════════════════════════════════════════
CURRENT_MONTH = "มิ.ย.-69"          # 🗓🗓🗓 เปลี่ยนค่าเป้าหมายการเบิกจ่าย/ใช้จ่าย
...
MONTHLY_THRESHOLDS = {
    ...
    "พ.ย.-68": {"ภาพรวม": {"เบิกจ่าย": 22.00, "ใช้จ่าย": 25.34}, "รายจ่ายประจำ": {"เบิกจ่าย": 24.66, "ใช้จ่าย": 25.34}, "รายจ่ายลงทุน": {"เบิกจ่าย": 13.34, "ใช้จ่าย": 24.00}},
    "ธ.ค.-68": {"ภาพรวม": {"เบิกจ่าย": 33.00, "ใช้จ่าย": 38.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 37.00, "ใช้จ่าย": 38.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 20.00, "ใช้จ่าย": 36.00}},
    "ม.ค.-69": {"ภาพรวม": {"เบิกจ่าย": 40.33, "ใช้จ่าย": 45.67}, "รายจ่ายประจำ": {"เบิกจ่าย": 44.67, "ใช้จ่าย": 45.67}, "รายจ่ายลงทุน": {"เบิกจ่าย": 26.00, "ใช้จ่าย": 43.67}},
    "ก.พ.-69": {"ภาพรวม": {"เบิกจ่าย": 47.66, "ใช้จ่าย": 53.34}, "รายจ่ายประจำ": {"เบิกจ่าย": 52.34, "ใช้จ่าย": 53.34}, "รายจ่ายลงทุน": {"เบิกจ่าย": 32.00, "ใช้จ่าย": 51.34}},
    "มี.ค.-69": {"ภาพรวม": {"เบิกจ่าย": 55.00, "ใช้จ่าย": 61.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 60.00, "ใช้จ่าย": 61.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 38.00, "ใช้จ่าย": 59.00}},
    "เม.ย.-69": {"ภาพรวม": {"เบิกจ่าย": 62.00, "ใช้จ่าย": 67.67}, "รายจ่ายประจำ": {"เบิกจ่าย": 67.67, "ใช้จ่าย": 68.67}, "รายจ่ายลงทุน": {"เบิกจ่าย": 43.67, "ใช้จ่าย": 62.33}},
    "พ.ค.-69": {"ภาพรวม": {"เบิกจ่าย": 69.00, "ใช้จ่าย": 74.34}, "รายจ่ายประจำ": {"เบิกจ่าย": 75.34, "ใช้จ่าย": 76.34}, "รายจ่ายลงทุน": {"เบิกจ่าย": 49.34, "ใช้จ่าย": 65.66}},
    "มิ.ย.-69": {"ภาพรวม": {"เบิกจ่าย": 76.00, "ใช้จ่าย": 81.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 83.00, "ใช้จ่าย": 84.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 55.00, "ใช้จ่าย": 69.00}},
    "ก.ค.-69": {"ภาพรวม": {"เบิกจ่าย": 81.67, "ใช้จ่าย": 87.33}, "รายจ่ายประจำ": {"เบิกจ่าย": 88.00, "ใช้จ่าย": 89.33}, "รายจ่ายลงทุน": {"เบิกจ่าย": 61.67, "ใช้จ่าย": 79.33}},
    "ส.ค.-69": {"ภาพรวม": {"เบิกจ่าย": 87.34, "ใช้จ่าย": 93.66}, "รายจ่ายประจำ": {"เบิกจ่าย": 93.00, "ใช้จ่าย": 94.66}, "รายจ่ายลงทุน": {"เบิกจ่าย": 68.34, "ใช้จ่าย": 89.66}},
    "ก.ย.-69": {"ภาพรวม": {"เบิกจ่าย": 93.00, "ใช้จ่าย": 100.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 98.00, "ใช้จ่าย": 100.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 75.00, "ใช้จ่าย": 100.00}},
}
...
st.markdown("""
    ...
    <div class='header-main'> ผลการเบิกจ่ายงบประมาณและการใช้จ่ายภาครัฐ ณ สิ้นสุดเดือนมิถุนายน ปีงบประมาณ พ.ศ. 2569</div>  
""", unsafe_allow_html=True)
##📌📌📌 เปลี่ยนชื่อหัวข้อ
...
st.markdown(
    """
    <div style="text-align: right;">
        <div style="display:inline-block; padding:0.3em 1em; background-color:#427AB5; color:white; border-radius:8px; text-decoration:none; font-weight:normal;">
...
1. ข้อมูลผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ จากระบบ New GFMIS Thai กรมบัญชีกลาง | แสดงข้อมูล ณ ตั้งแต่ต้นปี งปม. ถึงสิ้นเดือนมิถุนายน ปี งปม. 2569 | เรียกข้อมูล ณ วันที่ 1 กรกฎาคม 2569
</div>
""", unsafe_allow_html=True)
st.markdown("""
<div style='text-align: left; font-size: 14px; font-weight: normal; margin-bottom: 10px;'>
...
# ─── สร้างตารางค่าเป้าหมายจาก MONTHLY_THRESHOLDS อัตโนมัติ ───
_months = list(MONTHLY_THRESHOLDS.keys())
_rows = {
    "ภาพรวม_เบิกจ่าย": [(m, MONTHLY_THRESHOLDS[m]["ภาพรวม"]["เบิกจ่าย"])       for m in _months],
    "ภาพรวม_ใช้จ่าย":  [(m, MONTHLY_THRESHOLDS[m]["ภาพรวม"]["ใช้จ่าย"])        for m in _months],
    "ประจำ_เบิกจ่าย":  [(m, MONTHLY_THRESHOLDS[m]["รายจ่ายประจำ"]["เบิกจ่าย"]) for m in _months],
    "ประจำ_ใช้จ่าย":   [(m, MONTHLY_THRESHOLDS[m]["รายจ่ายประจำ"]["ใช้จ่าย"])  for m in _months],
    "ลงทุน_เบิกจ่าย":  [(m, MONTHLY_THRESHOLDS[m]["รายจ่ายลงทุน"]["เบิกจ่าย"]) for m in _months],
    "ลงทุน_ใช้จ่าย":   [(m, MONTHLY_THRESHOLDS[m]["รายจ่ายลงทุน"]["ใช้จ่าย"])  for m in _months],
}
def _th(m):
    cls = ' class="green-text"' if m == CURRENT_MONTH else ""
    return f"<th{cls}>{m}</th>"
def _td(m, v):
    cls = ' class="green-text"' if m == CURRENT_MONTH else ""
    return f"<td{cls}>{v}</td>"

_header = "<tr><th>รายการ</th>" + "".join(_th(m) for m in _months) + "</tr>"
_body   = "".join(
    "<tr><td>" + lbl + "</td>" + "".join(_td(m, v) for m, v in cells) + "</tr>"
    for lbl, cells in _rows.items()
)
html_table = f"""
<style>
...
""", unsafe_allow_html=True)
    ...
    with tab1:
        st.dataframe(prepare_table(df_min, category="ภาพรวม"), width='stretch')

    with tab2:
        if not df_reg.empty:
            st.dataframe(prepare_table(df_reg, category="รายจ่ายประจำ"), width='stretch')
        else:
            st.info("ไม่มีข้อมูลสำหรับรายจ่ายประจำ")

    with tab3:
        if not df_inv.empty:
            st.dataframe(prepare_table(df_inv, category="รายจ่ายลงทุน"), width='stretch')
        else:
