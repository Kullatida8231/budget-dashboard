...
@st.cache_data
def load_data():
    file_path = "q3-69 April.xlsx"                                        # 📑📑📑 เปลี่ยนชื่อไฟล์
...
# ══════════════════════════════════════════════════════════════
CURRENT_MONTH = "เม.ย.-69"          # 🗓🗓🗓 เปลี่ยนค่าเป้าหมายการเบิกจ่าย/ใช้จ่าย
...
st.markdown("""
    ...
    <div class='header-main'> ผลการเบิกจ่ายงบประมาณและการใช้จ่ายภาครัฐ ณ สิ้นสุดเดือนพฤษภาคม ปีงบประมาณ พ.ศ. 2569</div>  
""", unsafe_allow_html=True)
##📌📌📌 เปลี่ยนชื่อหัวข้อ
...
1. ข้อมูลผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ จากระบบ New GFMIS Thai กรมบัญชีกลาง | แสดงข้อมูล ณ ตั้งแต่ต้นปี งปม. ถึงสิ้นเดือนพฤษภาคม ปี งปม. 2569 | เรียกข้อมูล ณ วันที่ 4 มิถุนายน 2569
</div>
""", unsafe_allow_html=True)
st.markdown("""
<div style='text-align: left; font-size: 14px; font-weight: normal; margin-bottom: 10px;'>
