...
@st.cache_data
def load_data():
    file_path = "q4-68 September.xlsx"
...
st.markdown("""
    ...
    <div class='header-main'>ผลการเบิกจ่ายงบประมาณและการใช้จ่ายภาครัฐ ณ สิ้นสุดปีงบประมาณ พ.ศ. 2568</div>
""", unsafe_allow_html=True)
#-----------------------------
...
1. ข้อมูลผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ จากระบบ New GFMIS Thai กรมบัญชีกลาง | แสดงข้อมูล ณ ตั้งแต่ต้นปี งปม. ถึงสิ้นเดือนกันยายน ปี งปม. 2568 | เรียกข้อมูล ณ วันที่ 17 ตุลาคม 2568
</div>
""", unsafe_allow_html=True)
st.markdown("""
<div style='text-align: left; font-size: 14px; font-weight: normal; margin-bottom: 10px;'>
...
def show_metrics(data, title):
    ...
    # ✅ เกณฑ์สีตามกลุ่ม (ดึงจาก THRESHOLDS ตาม CURRENT_MONTH)
    _cat_map = {"📊 ภาพรวม": "ภาพรวม", "🏢 รายจ่ายประจำ": "รายจ่ายประจำ", "🏗️ รายจ่ายลงทุน": "รายจ่ายลงทุน"}
    _cat = _cat_map.get(title, "ภาพรวม")
    disb_threshold = THRESHOLDS[_cat]["เบิกจ่าย"]
    spend_threshold = THRESHOLDS[_cat]["ใช้จ่าย"]
...
#---------------------------------------------------------------------------
# 🎯 ค่าเป้าหมายรายเดือน (ดึงจากตารางมาตรการเร่งรัดฯ ด้านบน)
# 👉 เปลี่ยนเพียง CURRENT_MONTH เพื่ออัปเดตค่าเป้าหมายทั่วทั้งระบบ
CURRENT_MONTH = "ก.ย.-68"

MONTHLY_THRESHOLDS = {
    "ต.ค.-67": {"ภาพรวม": {"เบิกจ่าย":  9.00, "ใช้จ่าย": 12.33}, "รายจ่ายประจำ": {"เบิกจ่าย": 11.67, "ใช้จ่าย": 12.00}, "รายจ่ายลงทุน": {"เบิกจ่าย":  5.67, "ใช้จ่าย": 13.00}},
    "พ.ย.-67": {"ภาพรวม": {"เบิกจ่าย": 18.00, "ใช้จ่าย": 24.67}, "รายจ่ายประจำ": {"เบิกจ่าย": 23.33, "ใช้จ่าย": 24.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 11.33, "ใช้จ่าย": 26.00}},
    "ธ.ค.-67": {"ภาพรวม": {"เบิกจ่าย": 27.00, "ใช้จ่าย": 37.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 35.00, "ใช้จ่าย": 36.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 17.00, "ใช้จ่าย": 39.00}},
    "ม.ค.-68": {"ภาพรวม": {"เบิกจ่าย": 35.67, "ใช้จ่าย": 45.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 42.33, "ใช้จ่าย": 43.33}, "รายจ่ายลงทุน": {"เบิกจ่าย": 23.00, "ใช้จ่าย": 48.00}},
    "ก.พ.-68": {"ภาพรวม": {"เบิกจ่าย": 44.33, "ใช้จ่าย": 53.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 49.67, "ใช้จ่าย": 50.67}, "รายจ่ายลงทุน": {"เบิกจ่าย": 29.00, "ใช้จ่าย": 57.00}},
    "มี.ค.-68": {"ภาพรวม": {"เบิกจ่าย": 53.00, "ใช้จ่าย": 61.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 57.00, "ใช้จ่าย": 58.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 35.00, "ใช้จ่าย": 66.00}},
    "เม.ย.-68": {"ภาพรวม": {"เบิกจ่าย": 60.33, "ใช้จ่าย": 67.33}, "รายจ่ายประจำ": {"เบิกจ่าย": 64.67, "ใช้จ่าย": 65.67}, "รายจ่ายลงทุน": {"เบิกจ่าย": 41.33, "ใช้จ่าย": 69.67}},
    "พ.ค.-68": {"ภาพรวม": {"เบิกจ่าย": 67.67, "ใช้จ่าย": 73.67}, "รายจ่ายประจำ": {"เบิกจ่าย": 72.33, "ใช้จ่าย": 73.33}, "รายจ่ายลงทุน": {"เบิกจ่าย": 47.67, "ใช้จ่าย": 73.33}},
    "มิ.ย.-68": {"ภาพรวม": {"เบิกจ่าย": 75.00, "ใช้จ่าย": 80.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 80.00, "ใช้จ่าย": 81.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 54.00, "ใช้จ่าย": 77.00}},
    "ก.ค.-68": {"ภาพรวม": {"เบิกจ่าย": 81.33, "ใช้จ่าย": 86.67}, "รายจ่ายประจำ": {"เบิกจ่าย": 86.00, "ใช้จ่าย": 87.33}, "รายจ่ายลงทุน": {"เบิกจ่าย": 62.67, "ใช้จ่าย": 84.67}},
    "ส.ค.-68": {"ภาพรวม": {"เบิกจ่าย": 87.67, "ใช้จ่าย": 93.33}, "รายจ่ายประจำ": {"เบิกจ่าย": 92.00, "ใช้จ่าย": 93.67}, "รายจ่ายลงทุน": {"เบิกจ่าย": 71.33, "ใช้จ่าย": 92.33}},
    "ก.ย.-68": {"ภาพรวม": {"เบิกจ่าย": 94.00, "ใช้จ่าย": 100.00}, "รายจ่ายประจำ": {"เบิกจ่าย": 98.00, "ใช้จ่าย": 100.00}, "รายจ่ายลงทุน": {"เบิกจ่าย": 80.00, "ใช้จ่าย": 100.00}},
}

# ค่าเป้าหมายของเดือนที่เลือก (ใช้ทั่วทั้งระบบ)
THRESHOLDS = MONTHLY_THRESHOLDS[CURRENT_MONTH]
...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        ...
        ในปีงบประมาณ พ.ศ. 2568 มีการจัดสรรงบประมาณรวมทั้งสิ้น {total_prb_disp:,.4f} ล้านบาท 
    ...
    st.markdown(
        f"""
        <div class="summary-text">
        ✨ <b>ข้อสังเกตของ PBO:</b><br><br>
        แม้ว่ากฎหมายจะบัญญัติให้รัฐบาลตั้งงบประมาณรายจ่ายลงทุนไม่น้อยกว่าร้อยละ 20 ของงบประมาณรายจ่ายประจำปี
        แต่ในขั้นตอนการบริหารงบประมาณ พระราชบัญญัติวิธีการงบประมาณ พ.ศ. 2561 
        ได้ให้อำนาจหน่วยงานตามกฎหมายในการโอนงบประมาณรายจ่าย ทำให้มีงบประมาณรายจ่ายลงทุนหลังโอนเปลี่ยนแปลงแตกต่างไปจากยอดตามพระราชบัญญัติ และเมื่อติดตามผลการเบิกจ่ายและใช้จ่ายงบประมาณรายจ่ายเมื่อเทียบกับงบประมาณรายจ่ายรวมทั้งสิ้น 
        และเทียบกับงบประมาณรายจ่ายหลังโอนเปลี่ยนแปลง พบว่า <b>สัดส่วนผลการเบิกจ่ายและการใช้จ่ายมีระดับลดลงจากร้อยละ 20 ค่อนข้างมาก</b><br><br>
        
        แม้ว่ารัฐบาลจะตั้งงบประมาณรายจ่ายลงทุนตามกฎหมายที่เกี่ยวข้อง 
        แต่ในขั้นตอนการบริหารกลับมีการเบิกจ่ายและใช้จ่ายในสัดส่วนที่ต่ำเมื่อเทียบกับงบประมาณทั้งหมดของประเทศ และเนื่องจากงบประมาณรายจ่ายลงทุนส่วนใหญ่เป็นงบประมาณสำหรับการก่อสร้างขนาดใหญ่ 
        ซึ่งต้องใช้ระยะเวลาดำเนินการหลายปี เมื่อมีการเบิกจ่ายและใช้จ่ายต่ำ<b>สะท้อนได้ว่าประชาชนจะได้รับประโยชน์จากโครงการก่อสร้างล่าช้า และประเทศเสียโอกาสในการใช้ประโยชน์โครงสร้างพื้นฐาน
        ดังนั้น ภาครัฐควรเร่งรัดผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ ให้เป็นไปตามเป้าหมาย เพื่อให้โครงการดำเนินการแล้วเสร็จภายในปีงบประมาณ</b>
        </div>
        """,
        unsafe_allow_html=True
    )
    ...
    total_all, num_low_disb_all, low_disb_all, num_low_spend_all, low_spend_all = summarize_ministry_text(
        df, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"]
    )
    ...
    total_reg, num_low_disb_reg, low_disb_reg, num_low_spend_reg, low_spend_reg = summarize_ministry_text(
        df_regular, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"]
    )
    ...
    total_inv, num_low_disb_inv, low_disb_inv, num_low_spend_inv, low_spend_inv = summarize_ministry_text(
        df_invest, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"]
    )
...
""", unsafe_allow_html=True)
    ...
    with tab1:
        show_central_table(df_central, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"])

    with tab2:
        df_central_reg = df_central[df_central["รายจ่ายประจำ/ลงทุน"] == "รายจ่ายประจำ"]
        if not df_central_reg.empty:
            show_central_table(df_central_reg, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลสำหรับรายจ่ายประจำ")
    ...
    with tab3:
        ...
        if not df_central_inv.empty:
            show_central_table(df_central_inv, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลสำหรับรายจ่ายลงทุน")
...
if "4️⃣ แผนบูรณาการ" in selected_menus:
    ...
    percent_disb = round((total_disb / total_after) * 100, 2) if total_after else 0
    percent_spend = round((total_spend / total_after) * 100, 2) if total_after else 0
    color_disb = "#00FF9F" if percent_disb >= THRESHOLDS["ภาพรวม"]["เบิกจ่าย"] else "#FF4B4B"
    color_spend = "#00FF9F" if percent_spend >= THRESHOLDS["ภาพรวม"]["ใช้จ่าย"] else "#FF4B4B"
    ...
    color_disb_r = "#00FF9F" if per_disb_r >= THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"] else "#FF4B4B"
    color_spend_r = "#00FF9F" if per_spend_r >= THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"] else "#FF4B4B"
    ...
    color_disb_i = "#00FF9F" if per_disb_i >= THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"] else "#FF4B4B"
    color_spend_i = "#00FF9F" if per_spend_i >= THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"] else "#FF4B4B"
    ...
    with tab1:
        st.dataframe(
            build_plan_table(df_plan, THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], THRESHOLDS["ภาพรวม"]["ใช้จ่าย"]),
    ...
    with tab2:
        if not df_reg.empty:
            st.dataframe(
                build_plan_table(df_reg, THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"]),
                use_container_width=True
            )
        else:
    ...
    with tab3:
        if not df_inv.empty:
            st.dataframe(
                build_plan_table(df_inv, THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"]),
                use_container_width=True
            )
        else:
    ...
    # 📊 Tab 1: ภาพรวม
    with tab1:
        show_plan_table(df_plan_selected, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"])

    # 🏢 Tab 2: รายจ่ายประจำ
    with tab2:
        if not df_plan_reg.empty:
            show_plan_table(df_plan_reg, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายประจำ")
    ...
    with tab3:
        if not df_plan_inv.empty:
            show_plan_table(df_plan_inv, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายลงทุน")
...
if "5️⃣ จังหวัดและกลุ่มจังหวัด" in selected_menus:
    ...
    # 📊 Tab 1: ภาพรวม
    with tab1:
        show_local_table(df_selected, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"])

    # 🏢 Tab 2: รายจ่ายประจำ
    with tab2:
        df_reg = df_selected[df_selected["รายจ่ายประจำ/ลงทุน"] == "รายจ่ายประจำ"]
        if not df_reg.empty:
            show_local_table(df_reg, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายประจำ")
    ...
    with tab3:
        ...
        if not df_inv.empty:
            show_local_table(df_inv, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายลงทุน")
...
""", unsafe_allow_html=True)
    ...
    # 📊 Tab 1: ภาพรวม
    with tab1:
        show_parliament_table(df_selected, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"])

    # 🏢 Tab 2: รายจ่ายประจำ
    with tab2:
        df_par_reg = df_selected[df_selected["รายจ่ายประจำ/ลงทุน"] == "รายจ่ายประจำ"]
        if not df_par_reg.empty:
            show_parliament_table(df_par_reg, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายประจำ")
    ...
    with tab3:
        ...
        if not df_par_inv.empty:
            show_parliament_table(df_par_inv, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายลงทุน")
...
if "7️⃣ ผลผลิต/โครงการ (ค้นหาชื่อ)" in selected_menus:
    ...
    # 📊 Tab 1: ภาพรวม
    with tab1:
        show_project_table(df_project, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"])

    # 🏢 Tab 2: รายจ่ายประจำ
    with tab2:
        df_reg = df_project[df_project["รายจ่ายประจำ/ลงทุน"] == "รายจ่ายประจำ"]
        if not df_reg.empty:
            show_project_table(df_reg, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายประจำ")
    ...
    with tab3:
        ...
        if not df_inv.empty:
            show_project_table(df_inv, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"])
        else:
            st.info("ไม่มีข้อมูลรายจ่ายลงทุน")
...
""", unsafe_allow_html=True)
    ...
    with tab1:
        show_dimension_table(df_dim, disb_thres=THRESHOLDS["ภาพรวม"]["เบิกจ่าย"], spend_thres=THRESHOLDS["ภาพรวม"]["ใช้จ่าย"], category="ภาพรวม")

    with tab2:
        show_dimension_table(df_dim_reg, disb_thres=THRESHOLDS["รายจ่ายประจำ"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายประจำ"]["ใช้จ่าย"], category="รายจ่ายประจำ")

    with tab3:
        show_dimension_table(df_dim_inv, disb_thres=THRESHOLDS["รายจ่ายลงทุน"]["เบิกจ่าย"], spend_thres=THRESHOLDS["รายจ่ายลงทุน"]["ใช้จ่าย"], category="รายจ่ายลงทุน")
