...
📊 **ในภาพรวม**  
มีกระทรวงทั้งหมด **{total_all} กระทรวง** ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_disb_all) if low_disb_all else "-"}  
และมีกระทรวงทั้งหมด **{len(low_spend_all)} กระทรวง** ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_spend_all) if low_spend_all else "-"}  

🏢 **รายจ่ายประจำ**  
มีกระทรวงทั้งหมด **{total_reg} กระทรวง** ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_disb_reg) if low_disb_reg else "-"}  
และมีกระทรวงทั้งหมด **{len(low_spend_reg)} กระทรวง** ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_spend_reg) if low_spend_reg else "-"}  

🏗️ **รายจ่ายลงทุน**  
มีกระทรวงทั้งหมด **{total_inv} กระทรวง** ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_disb_inv) if low_disb_inv else "-"}  
และมีกระทรวงทั้งหมด **{len(low_spend_inv)} กระทรวง** ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_spend_inv) if low_spend_inv else "-"}  
