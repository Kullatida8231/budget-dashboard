...
if "2️⃣ กระทรวง/หน่วยงาน" in selected_menus:
    ...
    st.markdown(f"""
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ในภาพรวม **📍{selected_ministry}** ได้รับจัดสรรงบประมาณ **{prb:,.4f} ล้านบาท**  
มีงบประมาณหลังโอนเปลี่ยนแปลง **{after:,.4f} ล้านบาท**  
มีการเบิกจ่าย **{disb:,.4f} ล้านบาท** (<span style="color:{color_disb}; font-weight:bold;">{per_disb:.2f}%</span> ของงบฯ หลังโอน)  
และมีการใช้จ่าย **{spend:,.4f} ล้านบาท** (<span style="color:{color_spend}; font-weight:bold;">{per_spend:.2f}%</span> ของงบฯ หลังโอน)  
""", unsafe_allow_html=True)
    ...
    with tab2:
        if not df_reg.empty:
            ...
            st.markdown(f"""
            **รายจ่ายประจำ**  
            งบประมาณ **{prb_r:,.4f} ล้านบาท**, หลังโอน **{after_r:,.4f} ล้านบาท**  
    ...
    with tab3:
        if not df_inv.empty:
            ...
            st.markdown(f"""
            **รายจ่ายลงทุน**  
            งบประมาณ **{prb_i:,.4f} ล้านบาท**, หลังโอน **{after_i:,.4f} ล้านบาท**  
