...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        f"""
        ✨ ข้อสังเกตของ PBO: ตามมาตรา 20 (1) แห่งพระราชบัญญัติวินัยการเงินการคลังของรัฐ พ.ศ. 2561 ได้บัญญัติให้รัฐบาลตั้งงบประมาณรายจ่ายลงทุนไม่น้อยกว่าร้อยละ 20 ของงบประมาณรายจ่ายประจำปี
        ซึ่งเมื่อถึงขั้นตอนการบริหารงบประมาณ พระราชบัญญัติวิธีการงบประมาณ พ.ศ. 2561 ได้ให้อำนาจหน่วยงานตามกฎหมายในการโอนงบประมาณรายจ่าย
        ...
        พบว่าสัดส่วนผลการเบิกจ่ายและการใช้จ่ายลดลงจากร้อยละ 20 เป็นอย่างมาก
        """,
        unsafe_allow_html=True
    )
