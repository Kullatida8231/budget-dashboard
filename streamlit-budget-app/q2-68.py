...
# ======================== 🔵 ฟังก์ชันสรุปผล กระทรวง/เทียบเท่ากระทรวง ======================== #
...
st.markdown("### จากการติดตามผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ <span style='color:blue;'>**ทั้งหมด {total_all} กระทรวง**</span> แยกตามประเภทงบประมาณรายจ่ายพบว่า")
st.markdown(f"""
จากการติดตามผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ <span style='color:blue;'>**ทั้งหมด {total_all} กระทรวง**</span> แยกตามประเภทงบประมาณรายจ่ายพบว่า  

📊 **ในภาพรวม**  
<span style='color:red;'>มีกระทรวงทั้งหมด **{num_low_disb_all} กระทรวง** ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_disb_all) if low_disb_all else "-"}  
<span style='color:red;'>และมีกระทรวงทั้งหมด **{num_low_spend_all} กระทรวง** ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_spend_all) if low_spend_all else "-"}  

🏢 **รายจ่ายประจำ**  
<span style='color:red;'>มีกระทรวงทั้งหมด **{num_low_disb_reg} กระทรวง** ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_disb_reg) if low_disb_reg else "-"}  
<span style='color:red;'>และมีกระทรวงทั้งหมด **{num_low_spend_reg} กระทรวง** ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_spend_reg) if low_spend_reg else "-"}  

🏗️ **รายจ่ายลงทุน**  
<span style='color:red;'>มีกระทรวงทั้งหมด **{num_low_disb_inv} กระทรวง** ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_disb_inv) if low_disb_inv else "-"}  
<span style='color:red;'>และมีกระทรวงทั้งหมด **{num_low_spend_inv} กระทรวง** ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_spend_inv) if low_spend_inv else "-"}  
