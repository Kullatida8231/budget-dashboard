...
if "1️⃣ ภาพรวมทั้งประเทศ" in selected_menus:
    ...
    df_ministry["%เบิกจ่าย"] = (df_ministry["เบิกจ่าย"] / df_ministry["งบฯ หลังโอน"]) * 100
    df_ministry["%ใช้จ่าย"] = (df_ministry["ใช้จ่าย"] / df_ministry["งบฯ หลังโอน"]) * 100
    df_ministry = df_ministry[["กระทรวง", "พรบ.", "งบฯ หลังโอน", "เบิกจ่าย", "%เบิกจ่าย", "ใช้จ่าย", "%ใช้จ่าย"]]
