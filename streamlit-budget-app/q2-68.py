...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        ...
        - มีการจัดสรรงบประมาณรวมทั้งสิ้น **{prb_all_sum:,.2f} ล้านบาท**  
        - มีงบประมาณหลังโอนเปลี่ยนแปลงรวมทั้งสิ้น **{after_all_sum:,.2f} ล้านบาท**  
        - มีงบประมาณรายจ่ายลงทุนรวมทั้งสิ้น **{prb_inv_sum:,.2f} ล้านบาท**  

        คิดเป็นร้อยละ **{ratio_invest_per_all:.2f}%** ของงบประมาณรายจ่ายทั้งสิ้น  
        และคิดเป็นร้อยละ **{ratio_invest_per_trans:.2f}%** ของงบประมาณรายจ่ายหลังโอนเปลี่ยนแปลงทั้งสิ้น
        """,
        unsafe_allow_html=True
    )
