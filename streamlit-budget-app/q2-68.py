...
if "1️⃣ ภาพรวมทั้งประเทศ" in selected_menus:
    ...
    st.markdown(f"""
    ในภาพรวม มีหน่วยงานทั้งหมด **{total_all} หน่วยงาน**  
    ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_disb_all) if low_disb_all else "-"}  
    และมีหน่วยงานทั้งหมด **{len(low_spend_all)} หน่วยงาน**  
    ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_spend_all) if low_spend_all else "-"}  

    เมื่อจำแนกตามประเภทงบประมาณรายจ่ายพบว่า  

    • **รายจ่ายประจำ** มีหน่วยงานทั้งหมด **{total_reg} หน่วยงาน**  
      ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_disb_reg) if low_disb_reg else "-"}  
      และมีหน่วยงานทั้งหมด **{len(low_spend_reg)} หน่วยงาน**  
      ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_spend_reg) if low_spend_reg else "-"}  

    • **รายจ่ายลงทุน** มีหน่วยงานทั้งหมด **{total_inv} หน่วยงาน**  
      ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_disb_inv) if low_disb_inv else "-"}  
      และมีหน่วยงานทั้งหมด **{len(low_spend_inv)} หน่วยงาน**  
      ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย ได้แก่ {", ".join(low_spend_inv) if low_spend_inv else "-"}  

    ---
    ดังนั้น หน่วยงานที่มีผลการเบิกจ่ายงบประมาณและมีผลการใช้จ่ายเงินของรัฐต่ำกว่าเป้าหมาย  
    ควรเร่งรัดให้มีการเบิกจ่ายและใช้จ่ายให้เป็นไปตามค่าเป้าหมายตามมาตรการฯ  
    เพื่อให้มีการใช้จ่ายงบประมาณเป็นไปตามวัตถุประสงค์ของการขอรับจัดสรรงบประมาณ  
