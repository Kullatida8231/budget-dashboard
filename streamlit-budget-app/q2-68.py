...
st.markdown("""
    ...
    <div class='header-main'>⚠️(อยู่ระหว่างปรับปรุงข้อมูล) ผลการเบิกจ่ายและใช้จ่ายงบประมาณ ณ สิ้นสุดปีงบประมาณ พ.ศ. 2568)</div>
""", unsafe_allow_html=True)
#-----------------------------
...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        ...
        และเทียบกับงบประมาณรายจ่ายหลังโอนเปลี่ยนแปลง พบว่า <b>สัดส่วนผลการเบิกจ่ายและการใช้จ่ายลดลงจากร้อยละ 20 เป็นอย่างมาก</b><br><br>
