...
# เฉพาะคอลัมน์ที่จะแสดงในแต่ละมุมมอง
...
# เรียงลำดับตามงบฯ หลังโอนของแต่ละมุมมอง (ถ้ามีคอลัมน์)
...
# ---------- UI: ปุ่มเลือกตาราง (ด้านล่าง) ----------
# ใช้ session_state เพื่อคงมุมมองที่เลือกไว้
