...
if "2️⃣ กระทรวง/หน่วยงาน" in selected_menus:
    ...
    st.markdown(f"""
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ในภาพรวม **📍{selected_ministry}**  
ได้รับจัดสรรงบประมาณ **{prb:,.4f} ล้านบาท**  
มีงบประมาณหลังโอนเปลี่ยนแปลง **{after:,.4f} ล้านบาท**  
มีการเบิกจ่าย **{disb:,.4f} ล้านบาท**  
(<span style="color:{color_disb}; font-weight:bold;">{per_disb:.2f}%</span> ของงบฯ หลังโอน)  
และมีการใช้จ่าย **{spend:,.4f} ล้านบาท**  
(<span style="color:{color_spend}; font-weight:bold;">{per_spend:.2f}%</span> ของงบฯ หลังโอน)
""", unsafe_allow_html=True)
    ...
    if not df_reg.empty:
        ...
        st.markdown(f"""
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **1. รายจ่ายประจำ** ได้รับจัดสรรงบประมาณ **{prb_r:,.4f} ล้านบาท**  
งบประมาณหลังโอนเปลี่ยนแปลง **{after_r:,.4f} ล้านบาท**  
เบิกจ่าย **{disb_r:,.4f} ล้านบาท** (<span style="color:{color_disb_r}; font-weight:bold;">{per_disb_r:.2f}%</span>)  
...
""", unsafe_allow_html=True)
    ...
    if not df_inv.empty:
        ...
        st.markdown(f"""
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **2. รายจ่ายลงทุน** ได้รับจัดสรรงบประมาณ **{prb_i:,.4f} ล้านบาท**  
งบประมาณหลังโอนเปลี่ยนแปลง **{after_i:,.4f} ล้านบาท**  
เบิกจ่าย **{disb_i:,.4f} ล้านบาท** (<span style="color:{color_disb_i}; font-weight:bold;">{per_disb_i:.2f}%</span>)  
