...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        f"""
        ✨ ข้อสังเกตของ PBO: แม้ว่ากฎหมายจะบัญญัติให้รัฐบาลตั้งงบประมาณรายจ่ายลงทุนไม่น้อยกว่าร้อยละ 20 ของงบประมาณรายจ่ายประจำปี
        แต่ในขั้นตอนการบริหารงบประมาณ พระราชบัญญัติวิธีการงบประมาณ พ.ศ. 2561 ได้ให้อำนาจหน่วยงานตามกฎหมายในการโอนงบประมาณรายจ่าย
        ทำให้มีงบประมาณรายจ่ายลงทุนหลังโอนเปลี่ยนแปลงแตกต่างไปจากยอดตามพระราชบัญญัติ และเมื่อติดตามผลการเบิกจ่ายและใช้จ่ายงบประมาณรายจ่ายเมื่อเทียบกับงบประมาณรายจ่ายรวมทั้งสิ้น และเทียบกับงบประมาณรายจ่ายหลังโอนเปลี่ยนแปลง
        พบว่า สัดส่วนผลการเบิกจ่ายและการใช้จ่ายลดลงจากร้อยละ 20 เป็นอย่างมาก
        
        ดังนั้น แม้ว่ารัฐบาลจะตั้งงบประมาณรายจ่ายลงทุนตามกฎหมายที่เกี่ยวข้อง 
        แต่ในขั้นตอนการบริหารกลับมีการเบิกจ่ายและใช้จ่ายในสัดส่วนที่ต่ำเมื่อเทียบกับงบประมาณทั้งหมดของประเทศ
        และเนื่องจากงบประมาณรายจ่ายลงทุนส่วนใหญ่เป็นงบประมาณสำหรับการก่อสร้างขนาดใหญ่ ซึ่งต้องใช้ระยะเวลาดำเนินการหลายปี
        เมื่อมีการเบิกจ่ายและใช้จ่ายต่ำ สะท้อนได้ว่าประชาชนจะได้รับประโยชน์จากโครงการก่อสร้างล่าช้า และประเทศเสียโอกาสในการใช้ประโน์โครงสร้างพื้นฐาน
        """,
        unsafe_allow_html=True
    )
