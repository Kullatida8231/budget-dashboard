...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        ...
        ได้ให้อำนาจหน่วยงานตามกฎหมายในการโอนงบประมาณรายจ่าย ทำให้มีงบประมาณรายจ่ายลงทุนหลังโอนเปลี่ยนแปลงแตกต่างไปจากยอดตามพระราชบัญญัติ<br><br>
        
        และเมื่อติดตามผลการเบิกจ่ายและใช้จ่ายงบประมาณรายจ่ายเมื่อเทียบกับงบประมาณรายจ่ายรวมทั้งสิ้น 
        ...
        แต่ในขั้นตอนการบริหารกลับมีการเบิกจ่ายและใช้จ่ายในสัดส่วนที่ต่ำเมื่อเทียบกับงบประมาณทั้งหมดของประเทศ<br><br>
        
        และเนื่องจากงบประมาณรายจ่ายลงทุนส่วนใหญ่เป็นงบประมาณสำหรับการก่อสร้างขนาดใหญ่ 
        ซึ่งต้องใช้ระยะเวลาดำเนินการหลายปี เมื่อมีการเบิกจ่ายและใช้จ่ายต่ำ 
        <b>สะท้อนได้ว่าประชาชนจะได้รับประโยชน์จากโครงการก่อสร้างล่าช้า และประเทศเสียโอกาสในการใช้ประโยชน์โครงสร้างพื้นฐาน</b>
        </div>
        """,
        unsafe_allow_html=True
    )
