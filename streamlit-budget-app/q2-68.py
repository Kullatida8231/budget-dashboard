...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    <div style='background-color:#1E1E1E; padding:15px; border-radius:10px; margin-bottom:15px;'>
        ...
        <ul>
            <li><span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_disb_all}</b> กระทรวง</span> 
                ที่เบิกจ่ายต่ำกว่าเป้า ได้แก่ {", ".join(low_disb_all) if low_disb_all else "-"}</li>
            <li><span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_spend_all}</b> กระทรวง</span> 
                ที่ใช้จ่ายต่ำกว่าเป้า ได้แก่ {", ".join(low_spend_all) if low_spend_all else "-"}</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='background-color:#1E1E1E; padding:15px; border-radius:10px; margin-bottom:15px;'>
        ...
        <ul>
            <li><span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_disb_reg}</b> กระทรวง</span> 
                ที่เบิกจ่ายต่ำกว่าเป้า ได้แก่ {", ".join(low_disb_reg) if low_disb_reg else "-"}</li>
            <li><span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_spend_reg}</b> กระทรวง</span> 
                ที่ใช้จ่ายต่ำกว่าเป้า ได้แก่ {", ".join(low_spend_reg) if low_spend_reg else "-"}</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='background-color:#1E1E1E; padding:15px; border-radius:10px; margin-bottom:15px;'>
        ...
        <ul>
            <li><span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_disb_inv}</b> กระทรวง</span> 
                ที่เบิกจ่ายต่ำกว่าเป้า ได้แก่ {", ".join(low_disb_inv) if low_disb_inv else "-"}</li>
            <li><span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_spend_inv}</b> กระทรวง</span> 
                ที่ใช้จ่ายต่ำกว่าเป้า ได้แก่ {", ".join(low_spend_inv) if low_spend_inv else "-"}</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    # ---- Block 4: ข้อเสนอแนะ ----
    st.markdown("""
    <div style='background-color:#262626; padding:15px; border-radius:10px;'>
        ✨ <b>ข้อเสนอแนะ:</b>  
        ควรเร่งรัดการเบิกจ่ายและใช้จ่ายของกระทรวงที่ต่ำกว่าเป้า  
        เพื่อให้สอดคล้องกับวัตถุประสงค์การจัดสรรงบประมาณ  
        และเพื่อการพัฒนาประเทศ แก้ปัญหาความเดือดร้อน และยกระดับคุณภาพชีวิตประชาชน
    </div>
    """, unsafe_allow_html=True)
