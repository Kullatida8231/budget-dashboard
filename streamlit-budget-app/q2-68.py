...
st.markdown(f"""
จากการติดตามผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ จำนวน **{total_all} กระทรวง** แยกตามประเภทงบประมาณรายจ่ายพบว่า  

st.markdown(
    f"<div style='font-size:22px; font-weight:bold;'>"
    f"จากการติดตามผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ "
    f"จำนวน {total_all} กระทรวง แยกตามประเภทงบประมาณรายจ่ายพบว่า"
    f"</div>",
    unsafe_allow_html=True
)
