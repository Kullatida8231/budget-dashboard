...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    # ----- แสดงหัวข้อ -----
    st.markdown("## 🔵 ⚠️(อยู่ระหว่างปรับปรุง) ติดตามผลการเบิกจ่ายและใช้จ่ายงบประมาณรายจ่ายลงทุน")
    ...
    st.markdown(
        f"""
        ในปีงบประมาณ พ.ศ. 2568 มีการจัดสรรงบประมาณรวมทั้งสิ้น **{total_prb_disp:,.4f} ล้านบาท** มีงบประมาณหลังโอนเปลี่ยนแปลงทั้งสิ้น **{total_trans_disp:,.4f} ล้านบาท** มีงบประมาณรายจ่ายลงทุนรวมทั้งสิ้น **{total_invest_disp:,.4f} ล้านบาท** โดยมีผลการเบิกจ่ายและใช้จ่ายดังนี้
        """,
        unsafe_allow_html=True
    )
    ...
    with c1:
        st.markdown(
            f"""
            <div class='kpi-card'>
              <div class='kpi-label'>เบิกจ่ายงบประมาณายจ่ายลงทุน</div>
              <div class='kpi-value'>{total_invest_disb_disp:,.4f}</div>
              <div class='kpi-label'>ล้านบาท</div>
              <div class='kpi-sub'>
    ...
    with c2:
        st.markdown(
            ...
            <div class='kpi-card'>
              ...
              <div class='kpi-value'>{total_invest_spend_disp:,.4f} </div>
              <div class='kpi-label'>ล้านบาท</div>
              <div class='kpi-sub'>
