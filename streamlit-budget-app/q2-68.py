...
st.markdown("""
    ...
    <div class='header-main'>(อยู่ระหว่างปรับปรุง) ผลการเบิกจ่ายและใช้จ่ายงบประมาณ ณ สิ้นสุดเดือนพฤษภาคม พ.ศ. 2568 (เทียบเป้าหมายไตรมาส 2)</div>
""", unsafe_allow_html=True)
#-----------------------------
...
def get_color(value, category, target_type):
    ...
    """
    thresholds = {
        "ภาพรวม": {"เบิกจ่าย": 53, "ใช้จ่าย": 61},
        "รายจ่ายประจำ": {"เบิกจ่าย": 57, "ใช้จ่าย": 58},
        "รายจ่ายลงทุน": {"เบิกจ่าย": 35, "ใช้จ่าย": 66},
    }
...
if "7️⃣ ผลผลิต/โครงการ (ค้นหาชื่อ)" in selected_menus:
    st.markdown("## 7️⃣ ผลผลิต/โครงการ (ค้าหาชื่อผลผลิต/โครงการ)")
