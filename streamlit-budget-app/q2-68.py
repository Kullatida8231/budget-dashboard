...
if "1️⃣ ภาพรวมทั้งประเทศ" in selected_menus:
    ...
    with tab1:
        df_all = df.copy()
        df_all_grouped = df_all.groupby("กระทรวง")[["พรบ.", "งบฯ หลังโอน", "เบิกจ่าย", "ใช้จ่าย"]].sum().reset_index()
        ...
        def highlight_all(row):
            color_disb = get_color(row["%เบิกจ่าย"], "ภาพรวม", "เบิกจ่าย")
            color_spend = get_color(row["%ใช้จ่าย"], "ภาพรวม", "ใช้จ่าย")
            return ["", "", "", "", f"color: {color_disb}", "", f"color: {color_spend}"]

        styled_all = df_all_grouped[["กระทรวง", "พรบ.", "งบฯ หลังโอน", "เบิกจ่าย", "%เบิกจ่าย", "ใช้จ่าย", "%ใช้จ่าย"]
        ].style.format({
            "พรบ.": "{:,.4f}",
            "งบฯ หลังโอน": "{:,.4f}",
            "เบิกจ่าย": "{:,.4f}",
    ...
    with tab2:
        ...
        def highlight_reg(row):
            color_disb = get_color(row["%เบิกจ่าย"], "รายจ่ายประจำ", "เบิกจ่าย")
            color_spend = get_color(row["%ใช้จ่าย"], "รายจ่ายประจำ", "ใช้จ่าย")
            return ["", "", "", "", f"color: {color_disb}", "", f"color: {color_spend}"]

        styled_reg = df_reg_grouped[["กระทรวง", "พรบ.", "งบฯ หลังโอน", "เบิกจ่าย", "%เบิกจ่าย", "ใช้จ่าย", "%ใช้จ่าย"]
        ].style.format({
            "พรบ.": "{:,.4f}",
            "งบฯ หลังโอน": "{:,.4f}",
            "เบิกจ่าย": "{:,.4f}",
    ...
    with tab3:
        ...
        def highlight_inv(row):
            color_disb = get_color(row["%เบิกจ่าย"], "รายจ่ายลงทุน", "เบิกจ่าย")
            color_spend = get_color(row["%ใช้จ่าย"], "รายจ่ายลงทุน", "ใช้จ่าย")
            return ["", "", "", "", f"color: {color_disb}", "", f"color: {color_spend}"]

        styled_inv = df_inv_grouped[["กระทรวง", "พรบ.", "งบฯ หลังโอน", "เบิกจ่าย", "%เบิกจ่าย", "ใช้จ่าย", "%ใช้จ่าย"]
        ].style.format({
            "พรบ.": "{:,.4f}",
            "งบฯ หลังโอน": "{:,.4f}",
            "เบิกจ่าย": "{:,.4f}",
