...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        ...
        แต่ในขั้นตอนการบริหารกลับมีการเบิกจ่ายและใช้จ่ายในสัดส่วนที่ต่ำเมื่อเทียบกับงบประมาณทั้งหมดของประเทศ<br>และเนื่องจากงบประมาณรายจ่ายลงทุนส่วนใหญ่เป็นงบประมาณสำหรับการก่อสร้างขนาดใหญ่ 
