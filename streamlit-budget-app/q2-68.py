...
# --------------------------------------------------------------
# 🔸 ภาพรวมรายกระทรวง
show_ministry_table(df, "ผลการเบิกจ่ายและใช้จ่าย (ภาพรวมรายกระทรวง)", "ภาพรวม")

# 🔸 รายจ่ายประจำ (รายกระทรวง)
df_regular = df[df["รายจ่ายประจำ/ลงทุน"] == "รายจ่ายประจำ"]
show_ministry_table(df_regular, "ผลการเบิกจ่ายและใช้จ่าย (รายจ่ายประจำ: รายกระทรวง)", "รายจ่ายประจำ")

# 🔸 รายจ่ายลงทุน (รายกระทรวง)
df_invest = df[df["รายจ่ายประจำ/ลงทุน"] == "รายจ่ายลงทุน"]
show_ministry_table(df_invest, "ผลการเบิกจ่ายและใช้จ่าย (รายจ่ายลงทุน: รายกระทรวง)", "รายจ่ายลงทุน")
