...
selected_menus = st.sidebar.multiselect("📌 เลือกหัวข้อ Dashboard", [
    ...
    "(⚠️อยู่ระหว่างปรับปรุง)9️⃣ ลักษณะงาน"  # 
])
...
st.markdown("""
    ...
    <div class='header-main'>ผลการเบิกจ่ายและใช้จ่ายงบประมาณ ณ สิ้นสุดปีงบประมาณ พ.ศ. 2568)</div>
""", unsafe_allow_html=True)
#-----------------------------
...
# ===== ปุ่มดาวน์โหลดไฟล์ Excel (ชิดขวา, คนละบรรทัด) =====
...
# ช่องว่างด้านบนเล็กน้อย (ถ้าอยากให้ห่างจากปุ่มก่อนหน้า)
st.markdown("<div style='height:8px'></div>", unsafe_allow_html=True)

# ใช้คอลัมน์ดันปุ่มไปขวาสุด
_, right = st.columns([0.7, 0.3])   # ปรับสัดส่วนได้ตามต้องการ
with right:
    st.download_button(
...
1. ข้อมูลผลการเบิกจ่ายงบประมาณและการใช้จ่ายของรัฐ จากระบบ New GFMIS Thai กรมบัญชีกลาง | แสดงข้อมูล ณ ตั้งแต่ต้นปี งปม. ถึงสิ้นเดือนกันยายน ปี งปม. 2568 | เรียกข้อมูล ณ วันที่ 1 ตุลาคม 2568
</div>
""", unsafe_allow_html=True)
st.markdown("""
<div style='text-align: left; font-size: 14px; font-weight: normal; margin-bottom: 10px;'>
...
if "1️⃣ ภาพรวมทั้งประเทศ/กระทรวงหรือเทียบเท่ากระทรวง" in selected_menus:
    ...
    st.markdown(
        ...
        และเทียบกับงบประมาณรายจ่ายหลังโอนเปลี่ยนแปลง พบว่า <b>สัดส่วนผลการเบิกจ่ายและการใช้จ่ายมีระดับที่ใกล้เคียงและลดลงจากร้อยละ 20</b><br><br>
        
        ดังนั้น แม้ว่ารัฐบาลจะตั้งงบประมาณรายจ่ายลงทุนตามกฎหมายที่เกี่ยวข้อง 
        ...
        ซึ่งต้องใช้ระยะเวลาดำเนินการหลายปี เมื่อมีการเบิกจ่ายและใช้จ่ายต่ำ<b>สะท้อนได้ว่าประชาชนจะได้รับประโยชน์จากโครงการก่อสร้างล่าช้า และประเทศเสียโอกาสในการใช้ประโยชน์โครงสร้างพื้นฐาน</b>
        </div>
        """,
        unsafe_allow_html=True
    )
...
if "9️⃣ ลักษณะงาน" in selected_menus:
    st.markdown("## (⚠️อยู่ระหว่างปรับปรุง)9️⃣ ลักษณะงาน")
