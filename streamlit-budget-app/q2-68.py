...
if "1️⃣ ภาพรวมทั้งประเทศ" in selected_menus:
    ...
    📊 **ในภาพรวม**  
    <span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_disb_all} กระทรวง</b> ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_disb_all) if low_disb_all else "-"}  
    <span style='color:red;'>และมีกระทรวงทั้งหมด <b>{num_low_spend_all} กระทรวง</b> ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_spend_all) if low_spend_all else "-"}  

    🏢 **รายจ่ายประจำ**  
    <span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_disb_reg} กระทรวง</b> ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_disb_reg) if low_disb_reg else "-"}  
    <span style='color:red;'>และมีกระทรวงทั้งหมด <b>{num_low_spend_reg} กระทรวง</b> ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_spend_reg) if low_spend_reg else "-"}  

    🏗️ **รายจ่ายลงทุน**  
    <span style='color:red;'>มีกระทรวงทั้งหมด <b>{num_low_disb_inv} กระทรวง</b> ที่มีผลการเบิกจ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_disb_inv) if low_disb_inv else "-"}  
    <span style='color:red;'>และมีกระทรวงทั้งหมด <b>{num_low_spend_inv} กระทรวง</b> ที่มีผลการใช้จ่ายต่ำกว่าเป้าหมาย</span> ได้แก่ {", ".join(low_spend_inv) if low_spend_inv else "-"}  

    ---
    ✨✨✨ดังนั้น กระทรวงที่มีผลการเบิกจ่ายงบประมาณและมีผลการใช้จ่ายเงินของรัฐต่ำกว่าเป้าหมาย ควรเร่งรัดให้มีการเบิกจ่ายและใช้จ่ายให้เป็นไปตามค่าเป้าหมายตามมาตรการฯ  
    เพื่อให้การใช้จ่ายงบประมาณเป็นไปตามวัตถุประสงค์ของการขอรับจัดสรรงบประมาณ ทั้งในด้านการพัฒนาประเทศ การแก้ไขปัญหาความเดือดร้อนให้กับประชาชน และการยกระดับความเป็นอยู่ของประชาชน
    """, unsafe_allow_html=True)
